# read file in markdown format and the rssi_levels directory and convert them to markdown table format

# Usage: ruby tablelize_rssi.rb

require 'fileutils'

files = Dir.glob("rssi_levels/*.md")
levels = {}
files.each do |file|
  # read file content
...
File.write("rssi_levels_table.md", tables.join("\n"))
